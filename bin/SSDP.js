...
//######Server######
//var s = new SSDP;
//s.addUSN('upnp:rootdevice');
//s.addUSN('urn:schemas-upnp-org:device:MediaServer:1');
//s.addUSN('urn:schemas-upnp-org:service:ContentDirectory:1');
//s.addUSN('urn:schemas-upnp-org:service:ConnectionManager:1');
//
//s.on('advertise-alive', function (heads) {
//        console.log(heads);
//    // Expire old devices from your cache.
//    // Register advertising device somewhere (as designated in http headers heads)
//});
//
//s.on('advertise-bye', function (heads) {
//    console.log(heads);
