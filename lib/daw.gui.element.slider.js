...
//            return relVal;
        ...
        this.change = function (v) {
            this.cv = cObj.maxVal - v;//console.log("-<-<");console.log(this.cv);
            this.$.val(this.cv);
            return this;
        };
...
//                this.handleDiv = "<div class='handle' style='width:" + this.o.width + ";height:2px;background-color:black;'></div>";                
    ...
    // Listener
//    $.fn.dawSlider = function (options) {
//        return this.each(function () {
//                var slider = new guiElement.Slider(); //instanciate object
...
//    };
    ...
    $.fn.dawVerticalSlider = function (options) {
        return this.each(function () {
